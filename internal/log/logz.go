...
func init() {
	if logger == nil {
		lgz := log.NewLogger("golife-cli")
		if lgz == nil {
			logger = logz.NewLogger("golife-cli")
		}
		logger = lgz
	}
	if loggerCore == nil {
		loggerCore = logz.NewLogger("golife-cli-core")
	}
}
...
func Debug(args ...interface{}) {
	logger.Debug("Debug", map[string]interface{}{"context": "golife-cli", "pkg": "log", "method": "Debug", "args": args})
}

// Debugf logs a formatted message at level Debug on the standard logger.
func Debugf(format string, args ...interface{}) {
	logger.Debug(format, map[string]interface{}{"context": "golife-cli", "pkg": "log", "method": "Debug", "args": args})
}
...
func Info(args ...interface{}) {
	logger.Info(fmt.Sprintf("%s", args), map[string]interface{}{"context": "golife-cli", "pkg": "log", "method": "Info", "args": args})
}

// Infof logs a formatted message at level Info on the standard logger.
func Infof(format string, args ...interface{}) {
	logger.Info(format, map[string]interface{}{"context": "golife-cli", "pkg": "log", "method": "Info", "args": args})
}
...
func Warn(args ...interface{}) {
	logger.Warn("Warn", map[string]interface{}{"context": "golife-cli", "pkg": "log", "method": "Warn", "args": args})
}

// Warnf logs a formatted message at level Warn on the standard logger.
func Warnf(format string, args ...interface{}) {
	logger.Warn(format, map[string]interface{}{"context": "golife-cli", "pkg": "log", "method": "Warn", "args": args})
}
...
func Error(args ...interface{}) {
	logger.Error("Error", map[string]interface{}{"context": "golife-cli", "pkg": "log", "method": "Error", "args": args})
}

// Errorf logs a formatted message at level Error on the standard logger.
func Errorf(format string, args ...interface{}) {
	logger.Error(format, map[string]interface{}{"context": "golife-cli", "pkg": "log", "method": "Error", "args": args})
}
